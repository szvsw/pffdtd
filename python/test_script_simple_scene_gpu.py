...
sim_setup(
    model_json_file='../../acoustics-optimization/serialized_geometry.json',
    draw_backend='mayavi',
    ...
    fmax=2500.0,
    save_folder='../../acoustics-optimization/data/sim_data/test_setup/gpu',
    save_folder_gpu='../../acoustics-optimization/data/sim_data/test_setup/gpu',
